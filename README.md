...
当前正式版本：`0.3.12`
发布说明：[docs/releases/v0.3.12-release.md](docs/releases/v0.3.12-release.md)
更新总览：[CHANGELOG.md](CHANGELOG.md)
...
1. 准备与当前 Mac 芯片架构匹配的 `Presto` 安装包。
   `0.3.12` 当前只更新代码版本与发布文档，暂未生成安装包；如需安装包，请继续使用上一版 `0.3.11` 的 `Presto_0.3.11_arm64.dmg` / `Presto_0.3.11_x64.dmg`，校验值见 `0.3.11` 发布说明。
