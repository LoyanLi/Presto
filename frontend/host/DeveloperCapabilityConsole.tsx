...
import { invokePublicCapability } from './developerCapabilityInvoker'
...
type DeveloperCapabilityDefinition = BackendCapabilityDefinition &
  DeveloperCapabilityOverlay & {
    sideEffect: boolean
  }
...
function mergeCapabilityDefinition(
  capability: BackendCapabilityDefinition,
  overlay: DeveloperCapabilityOverlay,
): DeveloperCapabilityDefinition {
  return {
    ...overlay,
    ...capability,
    sideEffect: capability.kind !== 'query',
  }
}
...
function createSeedDefinitions(
  ...
  return CAPABILITY_REGISTRY
    ...
    .flatMap((capability) => {
      ...
      return [
        mergeCapabilityDefinition(capability, overlay),
      ]
    })
}
    ...
    void developerRuntime.backend
      ...
      const nextDefinitions = capabilities
        ...
        .flatMap((capability) => {
          ...
          return [mergeCapabilityDefinition(capability, overlay)]
        })
